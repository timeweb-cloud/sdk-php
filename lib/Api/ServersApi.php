...
/**
    ...
    public function commitRestorePointRequest($vds_id, string $contentType = self::contentTypes['commitRestorePoint'][0])
    {
        ...
        if ($vds_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$vds_id" when calling ServersApi.commitRestorePoint, must be bigger than or equal to 1.');
        }
    ...
    public function createRestorePointRequest($vds_id, string $contentType = self::contentTypes['createRestorePoint'][0])
    {
        ...
        if ($vds_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$vds_id" when calling ServersApi.createRestorePoint, must be bigger than or equal to 1.');
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetConfigurators200Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetAccountStatus403Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response
     */
    ...
    public function getRestorePointRequest($vds_id, string $contentType = self::contentTypes['getRestorePoint'][0])
    {
        ...
        if ($vds_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$vds_id" when calling ServersApi.getRestorePoint, must be bigger than or equal to 1.');
        }
     ...
     * @param  string $date_to Дата окончания сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: &#x60;2023-05-26T14%3A35%3A38&#x60; (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetServersPresets200Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetAccountStatus403Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response
     */
    ...
    public function rollbackRestorePointRequest($vds_id, string $contentType = self::contentTypes['rollbackRestorePoint'][0])
    {
        ...
        if ($vds_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$vds_id" when calling ServersApi.rollbackRestorePoint, must be bigger than or equal to 1.');
        }
