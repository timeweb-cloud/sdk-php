...
/**
     ...
     * @return \OpenAPI\Client\Model\GetLocations200Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetAccountStatus403Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response
     */
    public function getLocations(string $contentType = self::contentTypes['getLocations'][0])
    {
        list($response) = $this->getLocationsWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function getLocationsWithHttpInfo(string $contentType = self::contentTypes['getLocations'][0])
    {
        $request = $this->getLocationsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetLocations200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetLocations200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetLocations200Response', []),
            ...
            $returnType = '\OpenAPI\Client\Model\GetLocations200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetLocations200Response',
     ...
     */
    public function getLocationsAsync(string $contentType = self::contentTypes['getLocations'][0])
    {
        return $this->getLocationsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLocationsAsyncWithHttpInfo(string $contentType = self::contentTypes['getLocations'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetLocations200Response';
        $request = $this->getLocationsRequest($contentType);
     ...
     */
    public function getLocationsRequest(string $contentType = self::contentTypes['getLocations'][0])
    {
