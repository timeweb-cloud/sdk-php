...
/**
     ...
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
    ...
    /**
     * Operation copyStorageFile
     *
     * Копирование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\CopyStorageFileRequest $copy_storage_file_request copy_storage_file_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['copyStorageFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function copyStorageFile($bucket_id, $copy_storage_file_request, string $contentType = self::contentTypes['copyStorageFile'][0])
    {
        $this->copyStorageFileWithHttpInfo($bucket_id, $copy_storage_file_request, $contentType);
    }

    /**
     * Operation copyStorageFileWithHttpInfo
     *
     * Копирование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\CopyStorageFileRequest $copy_storage_file_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['copyStorageFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function copyStorageFileWithHttpInfo($bucket_id, $copy_storage_file_request, string $contentType = self::contentTypes['copyStorageFile'][0])
    {
        $request = $this->copyStorageFileRequest($bucket_id, $copy_storage_file_request, $contentType);
    ...
    /**
     * Operation copyStorageFileAsync
     *
     * Копирование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function copyStorageFileAsync($bucket_id, $copy_storage_file_request, string $contentType = self::contentTypes['copyStorageFile'][0])
    {
        return $this->copyStorageFileAsyncWithHttpInfo($bucket_id, $copy_storage_file_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation copyStorageFileAsyncWithHttpInfo
     *
     * Копирование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function copyStorageFileAsyncWithHttpInfo($bucket_id, $copy_storage_file_request, string $contentType = self::contentTypes['copyStorageFile'][0])
    {
        $returnType = '';
        $request = $this->copyStorageFileRequest($bucket_id, $copy_storage_file_request, $contentType);
    ...
    /**
     * Create request for operation 'copyStorageFile'
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\CopyStorageFileRequest $copy_storage_file_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['copyStorageFile'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function copyStorageFileRequest($bucket_id, $copy_storage_file_request, string $contentType = self::contentTypes['copyStorageFile'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling copyStorageFile'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.copyStorageFile, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'copy_storage_file_request' is set
        if ($copy_storage_file_request === null || (is_array($copy_storage_file_request) && count($copy_storage_file_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $copy_storage_file_request when calling copyStorageFile'
            );
        }


        $resourcePath = '/api/v1/storages/buckets/{bucket_id}/object-manager/copy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($copy_storage_file_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($copy_storage_file_request));
            } else {
                $httpBody = $copy_storage_file_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation createFolderInStorage
     *
     * Создание директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\CreateFolderInStorageRequest $create_folder_in_storage_request create_folder_in_storage_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFolderInStorage'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function createFolderInStorage($bucket_id, $create_folder_in_storage_request, string $contentType = self::contentTypes['createFolderInStorage'][0])
    {
        $this->createFolderInStorageWithHttpInfo($bucket_id, $create_folder_in_storage_request, $contentType);
    }

    /**
     * Operation createFolderInStorageWithHttpInfo
     *
     * Создание директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\CreateFolderInStorageRequest $create_folder_in_storage_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFolderInStorage'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function createFolderInStorageWithHttpInfo($bucket_id, $create_folder_in_storage_request, string $contentType = self::contentTypes['createFolderInStorage'][0])
    {
        $request = $this->createFolderInStorageRequest($bucket_id, $create_folder_in_storage_request, $contentType);
    ...
    /**
     * Operation createFolderInStorageAsync
     *
     * Создание директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFolderInStorageAsync($bucket_id, $create_folder_in_storage_request, string $contentType = self::contentTypes['createFolderInStorage'][0])
    {
        return $this->createFolderInStorageAsyncWithHttpInfo($bucket_id, $create_folder_in_storage_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createFolderInStorageAsyncWithHttpInfo
     *
     * Создание директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFolderInStorageAsyncWithHttpInfo($bucket_id, $create_folder_in_storage_request, string $contentType = self::contentTypes['createFolderInStorage'][0])
    {
        $returnType = '';
        $request = $this->createFolderInStorageRequest($bucket_id, $create_folder_in_storage_request, $contentType);
    ...
    /**
     * Create request for operation 'createFolderInStorage'
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\CreateFolderInStorageRequest $create_folder_in_storage_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFolderInStorage'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createFolderInStorageRequest($bucket_id, $create_folder_in_storage_request, string $contentType = self::contentTypes['createFolderInStorage'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling createFolderInStorage'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.createFolderInStorage, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'create_folder_in_storage_request' is set
        if ($create_folder_in_storage_request === null || (is_array($create_folder_in_storage_request) && count($create_folder_in_storage_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_folder_in_storage_request when calling createFolderInStorage'
            );
        }


        $resourcePath = '/api/v1/storages/buckets/{bucket_id}/object-manager/mkdir';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_folder_in_storage_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_folder_in_storage_request));
            } else {
                $httpBody = $create_folder_in_storage_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation deleteStorageFile
     *
     * Удаление файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\DeleteStorageFileRequest $delete_storage_file_request delete_storage_file_request (required)
     * @param  bool $is_multipart Это логическое значение, которое используется для обозначения multipart-загрузки. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteStorageFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteStorageFile($bucket_id, $delete_storage_file_request, $is_multipart = null, string $contentType = self::contentTypes['deleteStorageFile'][0])
    {
        $this->deleteStorageFileWithHttpInfo($bucket_id, $delete_storage_file_request, $is_multipart, $contentType);
    }

    /**
     * Operation deleteStorageFileWithHttpInfo
     *
     * Удаление файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\DeleteStorageFileRequest $delete_storage_file_request (required)
     * @param  bool $is_multipart Это логическое значение, которое используется для обозначения multipart-загрузки. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteStorageFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteStorageFileWithHttpInfo($bucket_id, $delete_storage_file_request, $is_multipart = null, string $contentType = self::contentTypes['deleteStorageFile'][0])
    {
        $request = $this->deleteStorageFileRequest($bucket_id, $delete_storage_file_request, $is_multipart, $contentType);
    ...
    /**
     * Operation deleteStorageFileAsync
     *
     * Удаление файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteStorageFileAsync($bucket_id, $delete_storage_file_request, $is_multipart = null, string $contentType = self::contentTypes['deleteStorageFile'][0])
    {
        return $this->deleteStorageFileAsyncWithHttpInfo($bucket_id, $delete_storage_file_request, $is_multipart, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteStorageFileAsyncWithHttpInfo
     *
     * Удаление файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteStorageFileAsyncWithHttpInfo($bucket_id, $delete_storage_file_request, $is_multipart = null, string $contentType = self::contentTypes['deleteStorageFile'][0])
    {
        $returnType = '';
        $request = $this->deleteStorageFileRequest($bucket_id, $delete_storage_file_request, $is_multipart, $contentType);
    ...
    /**
     * Create request for operation 'deleteStorageFile'
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\DeleteStorageFileRequest $delete_storage_file_request (required)
     * @param  bool $is_multipart Это логическое значение, которое используется для обозначения multipart-загрузки. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteStorageFileRequest($bucket_id, $delete_storage_file_request, $is_multipart = null, string $contentType = self::contentTypes['deleteStorageFile'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling deleteStorageFile'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.deleteStorageFile, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'delete_storage_file_request' is set
        if ($delete_storage_file_request === null || (is_array($delete_storage_file_request) && count($delete_storage_file_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $delete_storage_file_request when calling deleteStorageFile'
            );
        }



        $resourcePath = '/api/v1/storages/buckets/{bucket_id}/object-manager/remove';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($delete_storage_file_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($delete_storage_file_request));
            } else {
                $httpBody = $delete_storage_file_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation getStorageFilesList
     *
     * Получение списка файлов в хранилище по префиксу
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  string $prefix Префикс для поиска файла. (optional)
     * @param  bool $is_multipart Это логическое значение, которое используется для обозначения multipart-загрузки. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getStorageFilesList'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetStorageFilesList200Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetFinances403Response|\OpenAPI\Client\Model\GetImage404Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response
     */
    public function getStorageFilesList($bucket_id, $prefix = null, $is_multipart = null, string $contentType = self::contentTypes['getStorageFilesList'][0])
    {
        list($response) = $this->getStorageFilesListWithHttpInfo($bucket_id, $prefix, $is_multipart, $contentType);
        return $response;
    }

    /**
     * Operation getStorageFilesListWithHttpInfo
     *
     * Получение списка файлов в хранилище по префиксу
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return array of \OpenAPI\Client\Model\GetStorageFilesList200Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetFinances403Response|\OpenAPI\Client\Model\GetImage404Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStorageFilesListWithHttpInfo($bucket_id, $prefix = null, $is_multipart = null, string $contentType = self::contentTypes['getStorageFilesList'][0])
    {
        $request = $this->getStorageFilesListRequest($bucket_id, $prefix, $is_multipart, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetStorageFilesList200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetStorageFilesList200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetStorageFilesList200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetStorageFilesList200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation getStorageFilesListAsync
     *
     * Получение списка файлов в хранилище по префиксу
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorageFilesListAsync($bucket_id, $prefix = null, $is_multipart = null, string $contentType = self::contentTypes['getStorageFilesList'][0])
    {
        return $this->getStorageFilesListAsyncWithHttpInfo($bucket_id, $prefix, $is_multipart, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStorageFilesListAsyncWithHttpInfo
     *
     * Получение списка файлов в хранилище по префиксу
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorageFilesListAsyncWithHttpInfo($bucket_id, $prefix = null, $is_multipart = null, string $contentType = self::contentTypes['getStorageFilesList'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetStorageFilesList200Response';
        $request = $this->getStorageFilesListRequest($bucket_id, $prefix, $is_multipart, $contentType);
    ...
    /**
     * Create request for operation 'getStorageFilesList'
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  string $prefix Префикс для поиска файла. (optional)
     * @param  bool $is_multipart Это логическое значение, которое используется для обозначения multipart-загрузки. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getStorageFilesListRequest($bucket_id, $prefix = null, $is_multipart = null, string $contentType = self::contentTypes['getStorageFilesList'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling getStorageFilesList'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.getStorageFilesList, must be bigger than or equal to 1.');
        }
        



        $resourcePath = '/api/v1/storages/buckets/{bucket_id}/object-manager/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation renameStorageFile
     *
     * Переименование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\RenameStorageFileRequest $rename_storage_file_request rename_storage_file_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['renameStorageFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function renameStorageFile($bucket_id, $rename_storage_file_request, string $contentType = self::contentTypes['renameStorageFile'][0])
    {
        $this->renameStorageFileWithHttpInfo($bucket_id, $rename_storage_file_request, $contentType);
    }

    /**
     * Operation renameStorageFileWithHttpInfo
     *
     * Переименование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\RenameStorageFileRequest $rename_storage_file_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['renameStorageFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function renameStorageFileWithHttpInfo($bucket_id, $rename_storage_file_request, string $contentType = self::contentTypes['renameStorageFile'][0])
    {
        $request = $this->renameStorageFileRequest($bucket_id, $rename_storage_file_request, $contentType);
    ...
    /**
     * Operation renameStorageFileAsync
     *
     * Переименование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function renameStorageFileAsync($bucket_id, $rename_storage_file_request, string $contentType = self::contentTypes['renameStorageFile'][0])
    {
        return $this->renameStorageFileAsyncWithHttpInfo($bucket_id, $rename_storage_file_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation renameStorageFileAsyncWithHttpInfo
     *
     * Переименование файла/директории в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function renameStorageFileAsyncWithHttpInfo($bucket_id, $rename_storage_file_request, string $contentType = self::contentTypes['renameStorageFile'][0])
    {
        $returnType = '';
        $request = $this->renameStorageFileRequest($bucket_id, $rename_storage_file_request, $contentType);
    ...
    /**
     * Create request for operation 'renameStorageFile'
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \OpenAPI\Client\Model\RenameStorageFileRequest $rename_storage_file_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['renameStorageFile'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function renameStorageFileRequest($bucket_id, $rename_storage_file_request, string $contentType = self::contentTypes['renameStorageFile'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling renameStorageFile'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.renameStorageFile, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'rename_storage_file_request' is set
        if ($rename_storage_file_request === null || (is_array($rename_storage_file_request) && count($rename_storage_file_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $rename_storage_file_request when calling renameStorageFile'
            );
        }


        $resourcePath = '/api/v1/storages/buckets/{bucket_id}/object-manager/rename';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($rename_storage_file_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rename_storage_file_request));
            } else {
                $httpBody = $rename_storage_file_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  int $user_id Уникальный идентификатор пользователя хранилища. (required)
     ...
     * @param  string $path Путь до директории в хранилище (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadFileToStorage'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function uploadFileToStorage($bucket_id, $files, $path = null, string $contentType = self::contentTypes['uploadFileToStorage'][0])
    {
        $this->uploadFileToStorageWithHttpInfo($bucket_id, $files, $path, $contentType);
    }

    /**
     * Operation uploadFileToStorageWithHttpInfo
     *
     * Загрузка файлов в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadFileToStorageWithHttpInfo($bucket_id, $files, $path = null, string $contentType = self::contentTypes['uploadFileToStorage'][0])
    {
        $request = $this->uploadFileToStorageRequest($bucket_id, $files, $path, $contentType);
    ...
    /**
     * Operation uploadFileToStorageAsync
     *
     * Загрузка файлов в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileToStorageAsync($bucket_id, $files, $path = null, string $contentType = self::contentTypes['uploadFileToStorage'][0])
    {
        return $this->uploadFileToStorageAsyncWithHttpInfo($bucket_id, $files, $path, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation uploadFileToStorageAsyncWithHttpInfo
     *
     * Загрузка файлов в хранилище
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileToStorageAsyncWithHttpInfo($bucket_id, $files, $path = null, string $contentType = self::contentTypes['uploadFileToStorage'][0])
    {
        $returnType = '';
        $request = $this->uploadFileToStorageRequest($bucket_id, $files, $path, $contentType);
    ...
    /**
     * Create request for operation 'uploadFileToStorage'
     *
     * @param  int $bucket_id Уникальный идентификатор хранилища. (required)
     * @param  \SplFileObject[] $files (required)
     * @param  string $path Путь до директории в хранилище (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadFileToStorageRequest($bucket_id, $files, $path = null, string $contentType = self::contentTypes['uploadFileToStorage'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling uploadFileToStorage'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.uploadFileToStorage, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'files' is set
        if ($files === null || (is_array($files) && count($files) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $files when calling uploadFileToStorage'
            );
        }



        $resourcePath = '/api/v1/storages/buckets/{bucket_id}/object-manager/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
