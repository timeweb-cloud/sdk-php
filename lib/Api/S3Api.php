...
/**
     ...
     *
     * @param  int $bucket_id ID хранилища. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getStorage'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CreateStorage201Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetAccountStatus403Response|\OpenAPI\Client\Model\GetImage404Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response
     */
    public function getStorage($bucket_id, string $contentType = self::contentTypes['getStorage'][0])
    {
        list($response) = $this->getStorageWithHttpInfo($bucket_id, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\CreateStorage201Response|\OpenAPI\Client\Model\GetFinances400Response|\OpenAPI\Client\Model\GetFinances401Response|\OpenAPI\Client\Model\GetAccountStatus403Response|\OpenAPI\Client\Model\GetImage404Response|\OpenAPI\Client\Model\GetFinances429Response|\OpenAPI\Client\Model\GetFinances500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStorageWithHttpInfo($bucket_id, string $contentType = self::contentTypes['getStorage'][0])
    {
        $request = $this->getStorageRequest($bucket_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorageAsync($bucket_id, string $contentType = self::contentTypes['getStorage'][0])
    {
        return $this->getStorageAsyncWithHttpInfo($bucket_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorageAsyncWithHttpInfo($bucket_id, string $contentType = self::contentTypes['getStorage'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CreateStorage201Response';
        $request = $this->getStorageRequest($bucket_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getStorageRequest($bucket_id, string $contentType = self::contentTypes['getStorage'][0])
    {

        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket_id when calling getStorage'
            );
        }
        if ($bucket_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$bucket_id" when calling S3Api.getStorage, must be bigger than or equal to 1.');
        }
