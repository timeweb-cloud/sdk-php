...
/**
 * AvailableStaticRouteSubnetsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AvailableStaticRouteSubnetsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailableStaticRoute_subnets_inner';
    ...
    */
     ...
     * Sets subnet
     *
     * @param string $subnet Подсеть в формате CIDR
     *
     * @return self
     */
     ...
     * Sets network_name
     *
     * @param string $network_name Имя сети
     *
     * @return self
     */
