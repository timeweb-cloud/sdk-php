 ...
 */
class VdsImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vds_image';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Уникальный идентификатор образа сервера.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Название образа сервера.
     *
     * @return self
     */
     ...
     * Sets is_custom
     *
     * @param bool $is_custom Является ли образ кастомным.
     *
     * @return self
     */
