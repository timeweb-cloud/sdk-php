...
/**
 * AvailableStaticRoutesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AvailableStaticRoutesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailableStaticRoutesResponse';
    ...
    protected static $openAPITypes = [
        'response_id' => 'string',
        'available_networks' => '\OpenAPI\Client\Model\AvailableStaticRoute[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['available_networks'] === null) {
            $invalidProperties[] = "'available_networks' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\AvailableStaticRoute[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AvailableStaticRoute[] $available_networks Доступные подсети
     *
     * @return self
     */
