 ...
 */
class CreateVpc implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-vpc';
    ...
    */
     ...
     * Sets subnet_v4
     *
     * @param string $subnet_v4 Маска подсети.
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string $location Локация сети.
     *
     * @return self
     */
