 ...
 */
class CreateApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-app';
    ...
    */
     ...
     * Sets provider_id
     *
     * @param string $provider_id Уникальный идентификатор провайдера.
     *
     * @return self
     */
     ...
     * Sets repository_id
     *
     * @param string $repository_id Уникальный идентификатор репозитория.
     *
     * @return self
     */
     ...
     * Sets branch_name
     *
     * @param string $branch_name Название ветки репозитория из которой необходимо собрать приложение.
     *
     * @return self
     */
     ...
     * Sets is_auto_deploy
     *
     * @param bool $is_auto_deploy Автоматический деплой.
     *
     * @return self
     */
     ...
     * Sets commit_sha
     *
     * @param string $commit_sha Хэш коммита из которого необходимо собрать приложение.
     *
     * @return self
     */
