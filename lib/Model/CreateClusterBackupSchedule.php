...
/**
 * CreateClusterBackupSchedule Class Doc Comment
 *
 * @category Class
 * @description Расписание резервного копирования кластера базы данных.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateClusterBackupSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_cluster_backup_schedule';
    ...
    */
     ...
     * Sets copy_count
     *
     * @param int|null $copy_count Количество хранимых резервных копий.
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval Периодичность создания резервных копий.
     *
     * @return self
     */
     ...
     * Sets day_of_week
     *
     * @param int|null $day_of_week День недели (от 1 до 7) для создания резервной копии. Учитывается только при `interval: week`.
     *
     * @return self
     */
     ...
     * Sets day_of_month
     *
     * @param int|null $day_of_month День месяца (от 1 до 28) для создания резервной копии. Учитывается только при `interval: month`.
     *
     * @return self
     */
