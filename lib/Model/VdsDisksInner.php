...
/**
 * VdsDisksInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VdsDisksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vds_disks_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_mounted', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_mounted'] === null) {
            $invalidProperties[] = "'is_mounted' can't be null";
        }
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор диска.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float $size Размер диска (в Мб).
     *
     * @return self
     */
     ...
     * Sets used
     *
     * @param float $used Количество использованной памяти диска (в Мб).
     *
     * @return self
     */
    ...
    {
        return $this->container['is_mounted'];
    }

    /**
     * Sets is_mounted
     *
     * @param bool $is_mounted Является ли диск примонтированным.
     *
     * @return self
     */
    public function setIsMounted($is_mounted)
    {
        if (is_null($is_mounted)) {
            throw new \InvalidArgumentException('non-nullable is_mounted cannot be null');
        }
        $this->container['is_mounted'] = $is_mounted;
     ...
     * Sets is_system
     *
     * @param bool $is_system Является ли диск системным.
     *
     * @return self
     */
     ...
     * Sets system_name
     *
     * @param string $system_name Системное название диска.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус диска.
     *
     * @return self
     */
