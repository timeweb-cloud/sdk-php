...
/**
 * AppsPresetsBackendPresetsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AppsPresetsBackendPresetsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apps_presets_backend_presets_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Идентификатор пресета.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Описание пресета.
     *
     * @return self
     */
     ...
     *
     * @param string $description_short Краткое описание пресета.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param int $disk Объем диска в МБ.
     *
     * @return self
     */
     ...
     * Sets cpu_frequency
     *
     * @param string|null $cpu_frequency Частота CPU.
     *
     * @return self
     */
