 ...
 */
class UpdateDb implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update-db';
    ...
    protected static $setters = [
        ...
        'is_external_ip' => 'setIsExternalIp'
    ];
    ...
    protected static $getters = [
        ...
        'is_external_ip' => 'getIsExternalIp'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_external_ip', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets password
     *
     * @param string|null $password Пароль для подключения к базе данных.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Название базы данных.
     *
     * @return self
     */
     ...
     * Sets preset_id
     *
     * @param int|null $preset_id Идентификатор тарифа.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getIsExternalIp()
    {
        return $this->container['is_external_ip'];
    }
     ...
     * @return self
     */
    public function setIsExternalIp($is_external_ip)
    {
        if (is_null($is_external_ip)) {
            throw new \InvalidArgumentException('non-nullable is_external_ip cannot be null');
        }
        $this->container['is_external_ip'] = $is_external_ip;
