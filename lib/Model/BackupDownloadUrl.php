...
/**
 * BackupDownloadUrl Class Doc Comment
 *
 * @category Class
 * @description Ссылка для скачивания бэкапа базы данных.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BackupDownloadUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'backup-download-url';
    ...
    */
     ...
     * Sets backup_id
     *
     * @param string $backup_id ID резервной копии.
     *
     * @return self
     */
     ...
     * Sets download_url
     *
     * @param string $download_url Ссылка для скачивания бэкапа.
     *
     * @return self
     */
