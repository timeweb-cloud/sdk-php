...
/**
 * NetworkDrive Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkDrive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network-drive';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'size' => 'float',
        'service_list' => '\OpenAPI\Client\Model\NetworkDriveServiceListInner[]',
        'location' => 'string',
        'status' => 'string',
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Название сетевого диска.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float $size Размер диска в Гб
     *
     * @return self
     */
     ...
     * Gets service_list
     *
     * @return \OpenAPI\Client\Model\NetworkDriveServiceListInner[]
     */
     ...
     * Sets service_list
     *
     * @param \OpenAPI\Client\Model\NetworkDriveServiceListInner[] $service_list Список сервисов к которым подключен диск.
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string $location Локация сетевого диска.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус сетевого диска.
     *
     * @return self
     */
