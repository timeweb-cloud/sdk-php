...
/**
 * DatabaseAdminInstancesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatabaseAdminInstancesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database_admin_instances_inner';
    ...
    */
     ...
     * Sets instance_id
     *
     * @param float $instance_id Уникальный идентификатор базы данных
     *
     * @return self
     */
