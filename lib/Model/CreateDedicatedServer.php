...
class CreateDedicatedServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets preset_id
     *
     * @param float $preset_id Уникальный идентификатор тарифа выделенного сервера.
     *
     * @return self
     */
     ...
     * Sets os_id
     *
     * @param float|null $os_id Уникальный идентификатор операционной системы, которая будет установлена на выделенный сервер.
     *
     * @return self
     */
     ...
     * Sets cp_id
     *
     * @param float|null $cp_id Уникальный идентификатор панели управления, которая будет установлена на выделенный сервер.
     *
     * @return self
     */
     ...
     * Sets bandwidth_id
     *
     * @param float|null $bandwidth_id Уникальный идентификатор интернет-канала, который будет установлен на выделенный сервер.
     *
     * @return self
     */
     ...
     *
     * @param float|null $network_drive_id Уникальный идентификатор сетевого диска, который будет установлен на выделенный сервер.
     *
     * @return self
     */
     ...
     *
     * @param float|null $additional_ip_addr_id Уникальный идентификатор дополнительного IP-адреса, который будет установлен на выделенный сервер.
     *
     * @return self
     */
