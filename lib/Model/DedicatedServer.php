...
class DedicatedServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param float $id ID для каждого экземпляра выделенного сервера. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets node_id
     *
     * @param float $node_id Внутренний дополнительный ID сервера.
     *
     * @return self
     */
     ...
     * Sets os_id
     *
     * @param float $os_id ID операционной системы, установленной на выделенный сервер.
     *
     * @return self
     */
     ...
     * Sets cp_id
     *
     * @param float $cp_id ID панели управления, установленной на выделенный сервер.
     *
     * @return self
     */
     ...
     * Sets bandwidth_id
     *
     * @param float $bandwidth_id ID интернет-канала, установленного на выделенный сервер.
     *
     * @return self
     */
     ...
     *
     * @param float[] $network_drive_id Массив уникальных ID сетевых дисков, подключенных к выделенному серверу.
     *
     * @return self
     */
     ...
     *
     * @param float[] $additional_ip_addr_id Массив уникальных ID дополнительных IP-адресов, подключенных к выделенному серверу.
     *
     * @return self
     */
