...
/**
 * GetOsList200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetOsList200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOsList_200_response';
    ...
    */
     ...
     * Gets servers_os
     *
     * @return \OpenAPI\Client\Model\ServersOs[]
     */
    public function getServersOs()
    {
        return $this->container['servers_os'];
    }

    /**
     * Sets servers_os
     *
     * @param \OpenAPI\Client\Model\ServersOs[] $servers_os servers_os
     *
     * @return self
     */
    public function setServersOs($servers_os)
    {
        if (is_null($servers_os)) {
