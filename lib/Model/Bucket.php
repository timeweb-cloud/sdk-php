...
class Bucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор для каждого экземпляра хранилища. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets preset_id
     *
     * @param float $preset_id Идентификатор тарифа хранилища.
     *
     * @return self
     */
