...
/**
 * VdsNetworksInnerIpsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VdsNetworksInnerIpsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vds_networks_inner_ips_inner';
    ...
    */
     ...
     * Sets is_main
     *
     * @param bool $is_main Является ли сеть основной.
     *
     * @return self
     */
