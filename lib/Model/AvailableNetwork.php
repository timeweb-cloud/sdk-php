...
/**
 * AvailableNetwork Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AvailableNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailableNetwork';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subnet_v4'] === null) {
            $invalidProperties[] = "'subnet_v4' can't be null";
        }
     ...
     * Sets description
     *
     * @param string $description Описание сети
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getSubnetV4()
    {
        return $this->container['subnet_v4'];
    }

    /**
     * Sets subnet_v4
     *
     * @param string $subnet_v4 Подсеть IPv4
     *
     * @return self
     */
    public function setSubnetV4($subnet_v4)
    {
        if (is_null($subnet_v4)) {
            throw new \InvalidArgumentException('non-nullable subnet_v4 cannot be null');
        }
        $this->container['subnet_v4'] = $subnet_v4;
     ...
     *
     * @param string $availability_zone Зона доступности
     *
     * @return self
     */
     ...
     * Sets public_ip
     *
     * @param string $public_ip Публичный IP-адрес
     *
     * @return self
     */
     ...
     * Sets busy_address
     *
     * @param string[] $busy_address Занятые IP-адреса
     *
     * @return self
     */
