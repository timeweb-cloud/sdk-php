...
/**
 * DatabaseConfiguratorRequirements Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabaseConfiguratorRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database_configurator_requirements';
    ...
    */
     ...
     * Sets ram_min
     *
     * @param float $ram_min Минимальный объём оперативной памяти (в Мб).
     *
     * @return self
     */
     ...
     * Sets ram_step
     *
     * @param float $ram_step Размер шага оперативной памяти (в Мб).
     *
     * @return self
     */
     ...
     * Sets ram_max
     *
     * @param float $ram_max Максимальный объём оперативной памяти (в Мб).
     *
     * @return self
     */
     ...
     * Sets disk_step
     *
     * @param float $disk_step Размер шага диска (в Мб).
     *
     * @return self
     */
     ...
     *
     * @param float $network_bandwidth_min Минимальная пропускная способность интернет-канала (в Мбит/с).
     *
     * @return self
     */
     ...
     *
     * @param float $network_bandwidth_step Размер шага пропускной способности интернет-канала (в Мбит/с).
     *
     * @return self
     */
     ...
     *
     * @param float $network_bandwidth_max Максимальная пропускная способность интернет-канала (в Мбит/с).
     *
     * @return self
     */
