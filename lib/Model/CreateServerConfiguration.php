...
/**
 * CreateServerConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateServerConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_server_configuration';
    ...
    */
     ...
     *
     * @param float $configurator_id ID конфигуратора сервера.
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param float $ram Размер ОЗУ сервера в МБ.
     *
     * @return self
     */
