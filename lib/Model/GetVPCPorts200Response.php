...
/**
 * GetVPCPorts200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetVPCPorts200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getVPCPorts_200_response';
    ...
    */
     ...
     * Gets vpc_ports
     *
     * @return \OpenAPI\Client\Model\VpcPort[]
     */
    public function getVpcPorts()
    {
        return $this->container['vpc_ports'];
    }

    /**
     * Sets vpc_ports
     *
     * @param \OpenAPI\Client\Model\VpcPort[] $vpc_ports vpc_ports
     *
     * @return self
     */
    public function setVpcPorts($vpc_ports)
    {
        if (is_null($vpc_ports)) {
