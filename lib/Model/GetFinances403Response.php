...
class GetFinances403Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'float',
        'message' => '\OpenAPI\Client\Model\GetFinances403ResponseMessage',
        'error_code' => 'string',
        'response_id' => 'string'
    ];
    ...
    */
     ...
     * Gets message
     *
     * @return \OpenAPI\Client\Model\GetFinances403ResponseMessage|null
     */
     ...
     * Sets message
     *
     * @param \OpenAPI\Client\Model\GetFinances403ResponseMessage|null $message message
     *
     * @return self
     */
