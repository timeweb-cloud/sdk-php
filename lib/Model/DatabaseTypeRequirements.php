...
/**
 * DatabaseTypeRequirements Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabaseTypeRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database_type_requirements';
    ...
    */
     ...
     * Sets cpu_min
     *
     * @param float|null $cpu_min Минимальное количество CPU.
     *
     * @return self
     */
     ...
     * Sets ram_min
     *
     * @param float|null $ram_min Минимальный объем оперативной памяти.
     *
     * @return self
     */
     ...
     * Sets disk_min
     *
     * @param float|null $disk_min Минимальный объем дискового пространства.
     *
     * @return self
     */
