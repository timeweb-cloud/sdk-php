...
/**
 * CreateFloatingIp Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateFloatingIp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-floating-ip';
    ...
    */
     ...
     * Sets is_ddos_guard
     *
     * @param bool $is_ddos_guard Это логическое значение, которое показывает, включена ли защита от DDoS.
     *
     * @return self
     */
