...
/**
 * DeploySettingsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeploySettingsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deploy_settings_inner';
    ...
    */
     ...
     * Sets build_cmd
     *
     * @param string $build_cmd Команда для сборки проекта.
     *
     * @return self
     */
     ...
     * Sets index_dir
     *
     * @param string $index_dir Директория с индексными файлами.
     *
     * @return self
     */
     ...
     * Sets run_cmd
     *
     * @param string $run_cmd Команда для запуска проекта.
     *
     * @return self
     */
