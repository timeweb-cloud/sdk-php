 ...
 */
class AddGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'add-git';
    ...
    public const PROVIDER_TYPE_GIT = 'git';
    ...
    */
     ...
     * Sets provider_type
     *
     * @param string $provider_type Тип провайдера.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Внешний url адрес репозитория.
     *
     * @return self
     */
     ...
     * Sets login
     *
     * @param string|null $login Логин провайдера. Используется при добавлении приватных репозиториев
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Пароль или токен провайдера. Обязателен при добавлении приватных репозиториев. Подробнее в нашей <a href='https://timeweb.cloud/docs/apps/connecting-repositories#podkluchenie-repozitoriya-po-ssylke'>документации</a>.
     *
     * @return self
     */
