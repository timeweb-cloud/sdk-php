...
class ApiKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api-key';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_able_to_delete'] === null) {
            $invalidProperties[] = "'is_able_to_delete' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Уникальный идентификатор токена.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан токен.
     *
     * @return self
     */
     ...
     * Sets expired_at
     *
     * @param \DateTime $expired_at Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда истекает токен.
     *
     * @return self
     */
     ...
     *
     * @param bool $is_able_to_delete Это логическое значение, которое показывает, можно ли удалять управляемые сервисы при помощи данного токена без подтверждения через Телеграм, когда это подтверждение включено.
     *
     * @return self
     */
