...
/**
 * UpdateHttpResource Class Doc Comment
 *
 * @category Class
 * @description Параметры изменения CDN-ресурса. Передавайте только те поля, которые нужно изменить.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateHttpResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update-http-resource';
    ...
    protected static $openAPITypes = [
        ...
        'config' => '\OpenAPI\Client\Model\HttpResourceConfig'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Название CDN-ресурса.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateHttpResource., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateHttpResource., must be smaller than or equal to 255.');
        }
     ...
     * Sets preset_id
     *
     * @param int|null $preset_id ID тарифа CDN. Список доступных тарифов можно получить в `/api/v1/cdn/presets`.
     *
     * @return self
     */
     ...
     * Sets storage_id
     *
     * @param int|null $storage_id ID S3-хранилища, которое будет источником контента. Нельзя передавать вместе с `config.origin.servers`.
     *
     * @return self
     */
     ...
     *
     * @param int|null $traffic_limit_bytes Лимит исходящего трафика на расчетный месяц, в байтах. `null` — снять лимит. Если ресурс был остановлен по лимиту, при снятии или увеличении лимита раздача возобновится.
     *
     * @return self
     */
    public function setTrafficLimitBytes($traffic_limit_bytes)
    {
        ...
        if (!is_null($traffic_limit_bytes) && ($traffic_limit_bytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $traffic_limit_bytes when calling UpdateHttpResource., must be bigger than or equal to 0.');
        }
     ...
     * Gets config
     *
     * @return \OpenAPI\Client\Model\HttpResourceConfig|null
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\HttpResourceConfig|null $config config
     *
     * @return self
     */
