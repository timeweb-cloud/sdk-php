...
/**
 * UpdateServerIPRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateServerIPRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateServerIP_request';
    ...
    */
     ...
     * Sets ptr
     *
     * @param string $ptr PTR-запись IP-адреса
     *
     * @return self
     */
