 ...
 *
 * @category Class
 * @description SSL-сертификат CDN
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Certificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID сертификата. Указывается в поле `config.security.certificate_id` при привязке сертификата к ресурсу.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Тип сертификата. - `lets_encrypt` — сертификат, выпущенный через Let's Encrypt; - `uploaded` — сертификат, загруженный вами.
     *
     * @return self
     */
     ...
     * Sets cn
     *
     * @param string $cn Основное доменное имя сертификата.
     *
     * @return self
     */
     ...
     * Sets domains
     *
     * @param string[] $domains Все доменные имена сертификата, включая указанные в SAN.
     *
     * @return self
     */
     ...
     * Sets issued_at
     *
     * @param \DateTime $issued_at Дата выпуска сертификата.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at Дата окончания действия сертификата.
     *
     * @return self
     */
