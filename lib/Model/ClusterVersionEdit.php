...
/**
 * ClusterVersionEdit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClusterVersionEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClusterVersionEdit';
    ...
    */
     ...
     * Sets k8s_version
     *
     * @param string|null $k8s_version Новая версия кластера
     *
     * @return self
     */
