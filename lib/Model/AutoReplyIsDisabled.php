...
class AutoReplyIsDisabled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auto-reply-is-disabled';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Сообщение автоответчика на входящие письма
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject Тема сообщения автоответчика на входящие письма.
     *
     * @return self
     */
