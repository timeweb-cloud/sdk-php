 ...
 */
class AppDiskStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'app_disk_status';
    ...
    */
     ...
     * Sets used
     *
     * @param float|null $used Использованное пространство диска.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float|null $size Размер диска.
     *
     * @return self
     */
     ...
     * Sets disk_id
     *
     * @param float|null $disk_id Идентификатор диска.
     *
     * @return self
     */
