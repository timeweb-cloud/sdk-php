...
/**
 * UpdateServerConfigurator Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateServerConfigurator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_server_configurator';
    ...
    */
     ...
     *
     * @param float|null $configurator_id ID конфигуратора сервера.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param float|null $disk Размер диска в МБ.
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param float|null $ram Размер ОЗУ сервера в МБ.
     *
     * @return self
     */
     ...
     * Sets gpu
     *
     * @param float|null $gpu Количество видеокарт.
     *
     * @return self
     */
