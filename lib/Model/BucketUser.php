 ...
 */
class BucketUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bucket-user';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор пользователя.
     *
     * @return self
     */
     ...
     * Sets access_key
     *
     * @param string $access_key Логин пользователя.
     *
     * @return self
     */
     ...
     * Sets secret_key
     *
     * @param string $secret_key Пароль пользователя.
     *
     * @return self
     */
