...
/**
 * GetKubernetesPresets200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetKubernetesPresets200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getKubernetesPresets_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('k8s_presets', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['k8s_presets'] === null) {
            $invalidProperties[] = "'k8s_presets' can't be null";
        }
    ...
    {
        return $this->container['k8s_presets'];
    }
     ...
     * @return self
     */
    public function setK8sPresets($k8s_presets)
    {
        if (is_null($k8s_presets)) {
            throw new \InvalidArgumentException('non-nullable k8s_presets cannot be null');
        }
        $this->container['k8s_presets'] = $k8s_presets;
