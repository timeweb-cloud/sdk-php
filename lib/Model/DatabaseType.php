...
/**
 * DatabaseType Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabaseType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database-type';
    ...
    */
     ...
     * Sets version
     *
     * @param string $version Версия кластера базы данных.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Тип кластера базы данных. Передается при создании кластера в поле `type`
     *
     * @return self
     */
