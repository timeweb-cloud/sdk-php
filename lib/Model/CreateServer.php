...
class CreateServer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets os_id
     *
     * @param float|null $os_id Уникальный идентификатор операционной системы, которая будет установлена на облачный сервер. Нельзя передавать вместе с `image_id`.
     *
     * @return self
     */
     ...
     * Sets image_id
     *
     * @param string|null $image_id Уникальный идентификатор образа, который будет установлен на облачный сервер. Нельзя передавать вместе с `os_id`.
     *
     * @return self
     */
     ...
     * Sets software_id
     *
     * @param float|null $software_id Уникальный идентификатор программного обеспечения сервера.
     *
     * @return self
     */
     ...
     * Sets preset_id
     *
     * @param float|null $preset_id Уникальный идентификатор тарифа сервера. Нельзя передавать вместе с ключом `configurator`.
     *
     * @return self
     */
     ...
     * Sets avatar_id
     *
     * @param string|null $avatar_id Уникальный идентификатор аватара сервера. Описание методов работы с аватарами появится позднее.
     *
     * @return self
     */
