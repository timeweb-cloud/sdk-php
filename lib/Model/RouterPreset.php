...
/**
 * RouterPreset Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RouterPreset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RouterPreset';
    ...
    */
     ...
     * Sets node_count
     *
     * @param int $node_count Количество нод
     *
     * @return self
     */
     ...
     * Sets bandwidth
     *
     * @param int $bandwidth Пропускная способность
     *
     * @return self
     */
