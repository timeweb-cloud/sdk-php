...
/**
 * GetAuthAccessSettings200ResponseAllOfWhiteList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAuthAccessSettings200ResponseAllOfWhiteList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAuthAccessSettings_200_response_allOf_white_list';
    ...
    */
     ...
     * Sets ips
     *
     * @param string[] $ips Список разрешенных IP-адресов.
     *
     * @return self
     */
     ...
     * Sets countries
     *
     * @param string[] $countries Список разрешенных стран.
     *
     * @return self
     */
