 ...
 */
class DnsRecordV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dns-record-v2';
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'float',
        'fqdn' => 'string',
        'data' => '\OpenAPI\Client\Model\DnsRecordV2Data',
        'ttl' => 'float'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Тип DNS-записи.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param float|null $id ID DNS-записи.
     *
     * @return self
     */
     ...
     * Sets fqdn
     *
     * @param string|null $fqdn Полное имя основного домена.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\DnsRecordV2Data
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\DnsRecordV2Data $data data
     *
     * @return self
     */
