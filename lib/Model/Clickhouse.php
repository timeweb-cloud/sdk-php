...
class Clickhouse
{
    ...
    public const DROP_VIEW = 'DROP_VIEW';

    public const DROP_DICTIONARY = 'DROP_DICTIONARY';
    ...
    public const CREATE_TEMPORARY_TABLE = 'CREATE_TEMPORARY_TABLE';

    public const DICT_GET = 'dictGet';
