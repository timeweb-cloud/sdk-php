 ...
 */
class CreateDns implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-dns';
    ...
    */
     ...
     * Sets priority
     *
     * @param float|null $priority Приоритет DNS-записи.
     *
     * @return self
     */
     ...
     * Sets subdomain
     *
     * @param string|null $subdomain Полное имя поддомена.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Значение DNS-записи.
     *
     * @return self
     */
