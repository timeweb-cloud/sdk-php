 ...
 */
class SshKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ssh-key';
    ...
    protected static $openAPITypes = [
        ...
        'body' => 'string',
        'created_at' => '\DateTime',
        'used_by' => '\OpenAPI\Client\Model\SshKeyUsedByInner[]',
        'is_default' => 'bool'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор SSH-ключа
     *
     * @return self
     */
     ...
     * Gets used_by
     *
     * @return \OpenAPI\Client\Model\SshKeyUsedByInner[]
     */
