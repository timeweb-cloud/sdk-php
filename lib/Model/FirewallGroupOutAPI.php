...
/**
 * FirewallGroupOutAPI Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FirewallGroupOutAPI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirewallGroupOutAPI';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Идентификатор группы правил
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Дата и время последнего обновления
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Описание группы правил
     *
     * @return self
     */
