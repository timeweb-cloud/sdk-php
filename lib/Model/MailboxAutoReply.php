...
/**
 * MailboxAutoReply Class Doc Comment
 *
 * @category Class
 ...
 */
class MailboxAutoReply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mailbox_auto_reply';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message Сообщение автоответчика на входящие письма
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string $subject Тема сообщения автоответчика на входящие письма
     *
     * @return self
     */
