...
/**
 * BucketDiskStats Class Doc Comment
 *
 * @category Class
 ...
 */
class BucketDiskStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bucket_disk_stats';
    ...
    */
     ...
     * Sets used
     *
     * @param float $used Размер (в Кб) использованного пространства диска хранилища.
     *
     * @return self
     */
