 ...
 */
class EditApiKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edit-api-key';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Имя, установленное для токена.
     *
     * @return self
     */
