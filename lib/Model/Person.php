...
class Person implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('name_eng', $data ?? [], null);
        ...
        $this->setIfExists('is_blank', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name_eng'] === null) {
            $invalidProperties[] = "'name_eng' can't be null";
        }
     ...
     * Sets id
     *
     * @param int $id Уникальный идентификатор администратора домена.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Тип администратора: `person` — физическое лицо, `org` — организация, `ip` — индивидуальный предприниматель.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Имя администратора (ФИО или название организации).
     *
     * @return self
     */
    ...
    {
        return $this->container['name_eng'];
    }

    /**
     * Sets name_eng
     *
     * @param string $name_eng Имя администратора в латинской транслитерации.
     *
     * @return self
     */
    ...
    {
        if (is_null($name_eng)) {
            throw new \InvalidArgumentException('non-nullable name_eng cannot be null');
        }
        $this->container['name_eng'] = $name_eng;
     ...
     * Sets phone
     *
     * @param string $phone Контактный телефон администратора.
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string $country_code Код страны администратора.
     *
     * @return self
     */
     ...
     * Sets is_blank
     *
     * @param bool $is_blank Это логическое значение, которое показывает, заполнены ли данные администратора не полностью.
     *
     * @return self
     */
    ...
    {
        if (is_null($is_blank)) {
            throw new \InvalidArgumentException('non-nullable is_blank cannot be null');
        }
     ...
     * Sets is_closed
     *
     * @param bool $is_closed Это логическое значение, которое показывает, закрыт ли администратор.
     *
     * @return self
     */
     ...
     * Sets birthdate
     *
     * @param string|null $birthdate Дата рождения. Только для типов `person` и `ip`.
     *
     * @return self
     */
     ...
     * Sets passport_date
     *
     * @param string|null $passport_date Дата выдачи паспорта. Только для типов `person` и `ip`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $passport_number Номер паспорта. Только для типов `person` и `ip`.
     *
     * @return self
     */
     ...
     * Sets passport_place
     *
     * @param string|null $passport_place Кем выдан паспорт. Только для типов `person` и `ip`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $passport_series Серия паспорта. Только для типов `person` и `ip`.
     *
     * @return self
     */
     ...
     * Sets inn
     *
     * @param string|null $inn ИНН. Только для типов `org` и `ip`.
     *
     * @return self
     */
     ...
     * Sets kpp
     *
     * @param string|null $kpp КПП организации. Только для типа `org`.
     *
     * @return self
     */
     ...
     * Sets legal_address
     *
     * @param string|null $legal_address Юридический адрес организации. Только для типа `org`.
     *
     * @return self
     */
     ...
     * Sets contact_name
     *
     * @param string|null $contact_name Контактное лицо организации. Только для типа `org`.
     *
     * @return self
     */
