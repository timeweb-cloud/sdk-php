 ...
 */
class ClusterIn1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClusterIn_1';
    ...
    public const CONFIG_TYPE_BASIC = 'basic';
    public const CONFIG_TYPE_CUSTOM = 'custom';
    ...
    {
        return [
            self::CONFIG_TYPE_BASIC,
            self::CONFIG_TYPE_CUSTOM,
        ];
    }
