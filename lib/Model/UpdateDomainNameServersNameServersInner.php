...
/**
 * UpdateDomainNameServersNameServersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDomainNameServersNameServersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_domain_name_servers_name_servers_inner';
    ...
    */
     ...
     * Sets ips
     *
     * @param string[]|null $ips Список IP-адресов name-сервера
     *
     * @return self
     */
