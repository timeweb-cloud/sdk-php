...
/**
 * ConfigOriginAws Class Doc Comment
 *
 * @category Class
 * @description Ключи для доступа к источнику, совместимому с Amazon S3 API. &#x60;null&#x60; — не использовать авторизацию AWS.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConfigOriginAws implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'config_origin_aws';
