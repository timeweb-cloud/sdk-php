 ...
 */
class CreateAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-admin';
     ...
     * @return string[]
     */
    public function getPrivilegesAllowableValues()
    {
        return [
    ...
    */
     ...
     * Sets login
     *
     * @param string $login Имя пользователя базы данных
     *
     * @return self
     */
     ...
     * Sets instance_id
     *
     * @param float|null $instance_id ID инстанса базы данных для применения привилегий. Если поле не передано, то привилегии будут применены ко всем инстансам
     *
     * @return self
     */
     ...
     * Sets privileges
     *
     * @param string[] $privileges Список привилегий пользователя базы данных
     *
     * @return self
     */
    public function setPrivileges($privileges)
    {
        ...
        $allowedValues = $this->getPrivilegesAllowableValues();
        if (array_diff($privileges, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'privileges', must be one of '%s'",
