...
/**
 * MasterPresetOutApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MasterPresetOutApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MasterPresetOutApi';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'master');
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Уникальный идентификатор тарифа
     *
     * @return self
     */
     ...
     * Sets cpu
     *
     * @param int $cpu Количество ядер ноды
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param int $ram Количество памяти ноды
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param int $disk Количество пространства на ноде
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param int $network Пропускная способность ноды
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Тип тарифа
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Ограничение по количеству воркер-нод в кластере
     *
     * @return self
     */
