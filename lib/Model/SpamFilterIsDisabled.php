...
/**
 * SpamFilterIsDisabled Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpamFilterIsDisabled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'spam-filter-is-disabled';
    ...
    */
     ...
     * Sets action
     *
     * @param string|null $action Что делать с письмами, которые попадают в спам. \\  Параметры: \\  `move_to_directory` - переместить в паку спам; \\  `forward` - переслать письмо на другой адрес; \\  `delete` - удалить письмо; \\  `tag` - пометить письмо;
     *
     * @return self
     */
     ...
     * Sets forward_to
     *
     * @param string|null $forward_to Адрес для пересылки при выбранном действии `forward` из параметра `action`. Не может быть пустым, если `action` выбран `forward`
     *
     * @return self
     */
     ...
     * Sets white_list
     *
     * @param string[]|null $white_list Белый список адресов от которых письма не будут попадать в спам
     *
     * @return self
     */
