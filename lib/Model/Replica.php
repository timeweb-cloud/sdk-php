...
/**
 * Replica Class Doc Comment
 *
 * @category Class
 * @description Реплика кластера базы данных
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Replica implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replica';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'local_ip' => 'string',
        'disk' => '\OpenAPI\Client\Model\ReplicaDisk'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID реплики. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets local_ip
     *
     * @param string $local_ip IP-адрес реплики в локальной сети. Возвращается пустая строка, если адрес ещё не назначен.
     *
     * @return self
     */
     ...
     * Gets disk
     *
     * @return \OpenAPI\Client\Model\ReplicaDisk|null
     */
     ...
     * Sets disk
     *
     * @param \OpenAPI\Client\Model\ReplicaDisk|null $disk disk
     *
     * @return self
     */
