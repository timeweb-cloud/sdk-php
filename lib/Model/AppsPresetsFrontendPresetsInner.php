...
/**
 * AppsPresetsFrontendPresetsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AppsPresetsFrontendPresetsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apps_presets_frontend_presets_inner';
    ...
    */
     ...
     * Sets requests
     *
     * @param int $requests Количество запросов.
     *
     * @return self
     */
