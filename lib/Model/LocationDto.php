...
class LocationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'location-dto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('availability_zones', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['availability_zones'] === null) {
            $invalidProperties[] = "'availability_zones' can't be null";
        }
     ...
     * Sets location_code
     *
     * @param string $location_code Код локации в формате `ISO 3166`
     *
     * @return self
     */
     ...
     *
     * @param string[] $availability_zones Список зон, доступных в данной локации
     *
     * @return self
     */
    public function setAvailabilityZones($availability_zones)
    {
        if (is_null($availability_zones)) {
            throw new \InvalidArgumentException('non-nullable availability_zones cannot be null');
        }
