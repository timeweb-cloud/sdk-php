...
/**
 * GetDedicatedServersPresets200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDedicatedServersPresets200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDedicatedServersPresets_200_response';
    ...
    */
    ...
    /**
     * Gets dedicated_servers_presets
     *
     * @return \OpenAPI\Client\Model\DedicatedServerPreset[]
     */
    public function getDedicatedServersPresets()
    {
        return $this->container['dedicated_servers_presets'];
    }

    /**
     * Sets dedicated_servers_presets
     *
     * @param \OpenAPI\Client\Model\DedicatedServerPreset[] $dedicated_servers_presets dedicated_servers_presets
     *
     * @return self
     */
    public function setDedicatedServersPresets($dedicated_servers_presets)
    {
        if (is_null($dedicated_servers_presets)) {
