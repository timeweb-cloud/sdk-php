 ...
 */
class CreateDb implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-db';
    ...
    */
     ...
     * Sets login
     *
     * @param string|null $login Логин для подключения к базе данных.
     *
     * @return self
     */
