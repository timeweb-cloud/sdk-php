...
/**
 * StaticRouteOut Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StaticRouteOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StaticRouteOut';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID статического маршрута
     *
     * @return self
     */
     ...
     * Sets subnet
     *
     * @param string $subnet Сеть назначения в формате CIDR
     *
     * @return self
     */
