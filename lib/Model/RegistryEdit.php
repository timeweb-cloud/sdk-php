...
/**
 * RegistryEdit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RegistryEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegistryEdit';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description Новое описание реестра
     *
     * @return self
     */
