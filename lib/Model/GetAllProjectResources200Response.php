...
/**
 * GetAllProjectResources200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAllProjectResources200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllProjectResources_200_response';
    ...
    protected static $openAPITypes = [
        'servers' => '\OpenAPI\Client\Model\Vds[]',
        'balancers' => '\OpenAPI\Client\Model\Balancer[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('balancers', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['balancers'] === null) {
            $invalidProperties[] = "'balancers' can't be null";
        }
        ...
        if ($this->container['dedicated_servers'] === null) {
            $invalidProperties[] = "'dedicated_servers' can't be null";
        }
     ...
     * Gets servers
     *
     * @return \OpenAPI\Client\Model\Vds[]
     */
     ...
     * Sets servers
     *
     * @param \OpenAPI\Client\Model\Vds[] $servers servers
     *
     * @return self
     */
     ...
     * Gets balancers
     *
     * @return \OpenAPI\Client\Model\Balancer[]
     */
    public function getBalancers()
    {
        return $this->container['balancers'];
    }

    /**
     * Sets balancers
     *
     * @param \OpenAPI\Client\Model\Balancer[] $balancers balancers
     *
     * @return self
     */
    public function setBalancers($balancers)
    {
        if (is_null($balancers)) {
            throw new \InvalidArgumentException('non-nullable balancers cannot be null');
        }
        $this->container['balancers'] = $balancers;
     ...
     * Gets buckets
     *
     * @return \OpenAPI\Client\Model\Bucket[]
     */
     ...
     * Sets buckets
     *
     * @param \OpenAPI\Client\Model\Bucket[] $buckets buckets
     *
     * @return self
     */
     ...
     * Gets clusters
     *
     * @return \OpenAPI\Client\Model\Clusterk8s[]
     */
     ...
     * Sets clusters
     *
     * @param \OpenAPI\Client\Model\Clusterk8s[] $clusters clusters
     *
     * @return self
     */
     ...
     * Gets databases
     *
     * @return \OpenAPI\Client\Model\Db[]
     */
     ...
     * Sets databases
     *
     * @param \OpenAPI\Client\Model\Db[] $databases databases
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\DedicatedServer[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DedicatedServer[] $dedicated_servers dedicated_servers
     *
     * @return self
     */
