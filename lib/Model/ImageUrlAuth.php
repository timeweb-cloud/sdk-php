...
/**
 * ImageUrlAuth Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImageUrlAuth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageUrlAuth';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token Токен доступа к API облачного хранилища
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token Токен обновления доступов к API
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry Время истечения работы токена доступа
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string|null $token_type Тип токена доступа
     *
     * @return self
     */
