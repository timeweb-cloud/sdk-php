...
/**
 * GetClusterNodeGroups200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetClusterNodeGroups200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getClusterNodeGroups_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['node_groups'] === null) {
            $invalidProperties[] = "'node_groups' can't be null";
        }
     ...
     * Sets node_groups
     *
     * @param \OpenAPI\Client\Model\NodeGroupOut[] $node_groups Массив объектов Группа нод
     *
     * @return self
     */
