...
/**
 * DedicatedServerPresetCpu Class Doc Comment
 *
 * @category Class
 ...
 */
class DedicatedServerPresetCpu implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dedicated_server_preset_cpu';
    ...
    */
     ...
     * Sets description
     *
     * @param string $description Описание характеристик процессора выделенного сервера.
     *
     * @return self
     */
     ...
     *
     * @param string $description_short Краткое описание характеристик процессора выделенного сервера.
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param float $count Количество ядер процессора выделенного сервера.
     *
     * @return self
     */
