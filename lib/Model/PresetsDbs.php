 ...
 */
class PresetsDbs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'presets-dbs';
    ...
    */
     ...
     * Sets id
     *
     * @param float|null $id Уникальный идентификатор для каждого экземпляра тарифа базы данных.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Описание тарифа.
     *
     * @return self
     */
     ...
     *
     * @param string|null $description_short Краткое описание тарифа.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Стоимость тарифа базы данных
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string|null $location Географическое расположение тарифа.
     *
     * @return self
     */
