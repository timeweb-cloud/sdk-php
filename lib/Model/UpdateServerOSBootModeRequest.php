...
/**
 * UpdateServerOSBootModeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateServerOSBootModeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateServerOSBootMode_request';
    ...
    public const BOOT_MODE__DEFAULT = 'default';
    public const BOOT_MODE_SINGLE = 'single';
    public const BOOT_MODE_RECOVERY_DISK = 'recovery_disk';
    ...
    {
        return [
            self::BOOT_MODE__DEFAULT,
            self::BOOT_MODE_SINGLE,
            self::BOOT_MODE_RECOVERY_DISK,
        ];
    }
