...
/**
 * UpdateClusterV2 Class Doc Comment
 *
 * @category Class
 * @description Изменение кластера базы данных (v2)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateClusterV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update-cluster-v2';
    ...
    protected static $openAPITypes = [
        ...
        'maintenance_slot' => '\OpenAPI\Client\Model\UpdateClusterV2MaintenanceSlot',
        'disk_autoscaling' => '\OpenAPI\Client\Model\UpdateClusterV2DiskAutoscaling'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Название кластера базы данных.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_enabled_public_network Доступность публичного IP-адреса
     *
     * @return self
     */
     ...
     * Sets floating_ip
     *
     * @param string|null $floating_ip Плавающий IP-адрес, который нужно привязать к кластеру базы данных. Передается сам адрес, а не его ID; адрес должен быть свободен (не привязан к другому сервису).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_secure_connection_enable Включить защищенное подключение к кластеру базы данных. Обратите внимание: в ответе это же значение возвращается под ключом `is_secure_connection_enabled`.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\UpdateClusterV2MaintenanceSlot|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UpdateClusterV2MaintenanceSlot|null $maintenance_slot maintenance_slot
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\UpdateClusterV2DiskAutoscaling|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UpdateClusterV2DiskAutoscaling|null $disk_autoscaling disk_autoscaling
     *
     * @return self
     */
