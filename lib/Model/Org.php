 ...
 *
 * @category Class
 * @description Администратор домена — организация
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Org implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets contact_name
     *
     * @param string $contact_name Контактное лицо организации.
     *
     * @return self
     */
     ...
     * Sets legal_address
     *
     * @param string $legal_address Юридический адрес организации.
     *
     * @return self
     */
