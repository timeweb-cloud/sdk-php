 ...
 */
class VpcService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpc-service';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Идентификатор сервисв.
     *
     * @return self
     */
     ...
     * Sets public_ip
     *
     * @param string|null $public_ip Публичный IP-адрес сервиса
     *
     * @return self
     */
     ...
     * Sets local_ip
     *
     * @param string|null $local_ip Приватный IP-адрес сервиса
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Тип сервиса.
     *
     * @return self
     */
