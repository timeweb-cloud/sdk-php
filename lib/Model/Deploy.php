 ...
 */
class Deploy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deploy';
    ...
    protected static $openAPITypes = [
        ...
        'started_at' => '\DateTime',
        'ended_at' => '\DateTime',
        'status' => '\OpenAPI\Client\Model\DeployStatus',
        'commit_msg' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('commit_msg', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['commit_msg'] === null) {
            $invalidProperties[] = "'commit_msg' can't be null";
        }
     ...
     * Sets commit_sha
     *
     * @param string $commit_sha Хэш коммита.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at Время запуска деплоя.
     *
     * @return self
     */
     ...
     * Sets ended_at
     *
     * @param \DateTime $ended_at Время окончания деплоя. Определено для завершенных деплоев
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\DeployStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\DeployStatus $status status
     *
     * @return self
     */
    ...
    {
        return $this->container['commit_msg'];
    }

    /**
     * Sets commit_msg
     *
     * @param string $commit_msg Сообщение коммита.
     *
     * @return self
     */
    public function setCommitMsg($commit_msg)
    {
        if (is_null($commit_msg)) {
            throw new \InvalidArgumentException('non-nullable commit_msg cannot be null');
        }
        $this->container['commit_msg'] = $commit_msg;
