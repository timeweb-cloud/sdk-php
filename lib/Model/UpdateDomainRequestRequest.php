...
/**
 * UpdateDomainRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDomainRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateDomainRequest_request';
    ...
    public const PAYMENT_TYPE_MOBILE_CARD = 'mobile-card';
    public const PAYMENT_TYPE_WM = 'wm';
    public const PAYMENT_TYPE_WEBMONEY = 'webmoney';
    public const PAYMENT_TYPE_YANDEX = 'yandex';
    public const PAYMENT_TYPE_YA = 'ya';
    public const PAYMENT_TYPE_INVOICE = 'invoice';
    public const PAYMENT_TYPE_SOFORT = 'sofort';
    public const PAYMENT_TYPE_QIWI_WALLET = 'qiwi_wallet';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bonus_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bonus_id'] === null) {
            $invalidProperties[] = "'bonus_id' can't be null";
        }
     ...
     * Sets money_source
     *
     * @param string $money_source Тип создаваемой заявки.
     *
     * @return self
     */
    public function setMoneySource($money_source)
    {
        if (is_null($money_source)) {
            throw new \InvalidArgumentException('non-nullable money_source cannot be null');
        }
        $allowedValues = $this->getMoneySourceAllowableValues();
        if (!in_array($money_source, $allowedValues, true)) {
     ...
     * Sets payment_type
     *
     * @param string $payment_type Тип платежной системы.
     *
     * @return self
     */
     ...
     * Sets payer_id
     *
     * @param float $payer_id Идентификационный номер плательщика
     *
     * @return self
     */
     ...
     * Sets bonus_id
     *
     * @param float $bonus_id Идентификатор бонуса.
     *
     * @return self
     */
    ...
    {
        if (is_null($bonus_id)) {
            throw new \InvalidArgumentException('non-nullable bonus_id cannot be null');
        }
