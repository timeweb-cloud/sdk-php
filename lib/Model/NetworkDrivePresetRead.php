...
/**
 * NetworkDrivePresetRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkDrivePresetRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_drive_preset_read';
    ...
    */
     ...
     * Sets min
     *
     * @param float|null $min Чтение IOPS
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float|null $max Чтение IOPS
     *
     * @return self
     */
