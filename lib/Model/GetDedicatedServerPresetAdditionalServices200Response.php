...
/**
 * GetDedicatedServerPresetAdditionalServices200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDedicatedServerPresetAdditionalServices200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDedicatedServerPresetAdditionalServices_200_response';
    ...
    */
    ...
    /**
     * Gets dedicated_server_additional_services
     *
     * @return \OpenAPI\Client\Model\DedicatedServerAdditionalService[]
     */
    public function getDedicatedServerAdditionalServices()
    {
        return $this->container['dedicated_server_additional_services'];
    }

    /**
     * Sets dedicated_server_additional_services
     *
     * @param \OpenAPI\Client\Model\DedicatedServerAdditionalService[] $dedicated_server_additional_services dedicated_server_additional_services
     *
     * @return self
     */
    public function setDedicatedServerAdditionalServices($dedicated_server_additional_services)
    {
        if (is_null($dedicated_server_additional_services)) {
