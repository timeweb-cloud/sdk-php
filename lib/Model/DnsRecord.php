...
class DnsRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dns-record';
    ...
    */
     ...
     * Sets id
     *
     * @param float|null $id Идентификатор DNS-записи.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\DnsRecordData
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\DnsRecordData $data data
     *
     * @return self
     */
