...
/**
 * NodeGroupOut Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NodeGroupOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeGroupOut';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Уникальный идентификатор группы
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Дата и время создания группы в формате ISO8601
     *
     * @return self
     */
