...
/**
 * UpdateDomain Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update-domain';
    ...
    */
     ...
     * Sets linked_ip
     *
     * @param string|null $linked_ip Привязанный к домену IP-адрес.
     *
     * @return self
     */
