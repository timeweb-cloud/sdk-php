...
/**
 * AddStorageSubdomainsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddStorageSubdomainsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addStorageSubdomains_request';
    ...
    */
     ...
     * Sets subdomains
     *
     * @param string[] $subdomains subdomains
     *
     * @return self
     */
