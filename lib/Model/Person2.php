...
/**
 * Person2 Class Doc Comment
 *
 * @category Class
 * @description Администратор домена — физическое лицо
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Person2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'person-2';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name ФИО администратора.
     *
     * @return self
     */
