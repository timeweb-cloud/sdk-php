...
/**
 * NodeGroupInConfiguration Class Doc Comment
 *
 * @category Class
 * @description Параметры конфигурации воркер-ноды. Нельзя передавать вместе с &#x60;preset_id&#x60;. Локация воркер-нод должна совпадать с локацией кластера
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NodeGroupInConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeGroupIn_configuration';
    ...
    */
     ...
     *
     * @param int $configurator_id ID конфигуратора кластера
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param int $disk Размер диска в МБ
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param int $ram Размер ОЗУ сервера в МБ
     *
     * @return self
     */
