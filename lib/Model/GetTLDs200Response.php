...
/**
 * GetTLDs200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTLDs200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTLDs_200_response';
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\TopLevelDomain[] $top_level_domains top_level_domains
     *
     * @return self
     */
    public function setTopLevelDomains($top_level_domains)
    {
        if (is_null($top_level_domains)) {
