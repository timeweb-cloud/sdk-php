...
/**
 * ServersPreset Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServersPreset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'servers-preset';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор тарифа сервера.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float $price Стоимость в рублях.
     *
     * @return self
     */
     ...
     * Sets cpu
     *
     * @param float $cpu Количество ядер процессора.
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param float $ram Количество (в Мб) оперативной памяти.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param float $disk Размер диска (в Мб).
     *
     * @return self
     */
     ...
     * Sets bandwidth
     *
     * @param float $bandwidth Пропускная способность тарифа.
     *
     * @return self
     */
     ...
     *
     * @param string $description_short Короткое описание тарифа.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[] $tags Список тегов тарифа.
     *
     * @return self
     */
