 ...
 */
class DnatRuleOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DnatRuleOut';
    ...
    */
     ...
     * Sets local_ip
     *
     * @param string $local_ip Приватный IP-адрес
     *
     * @return self
     */
     ...
     * Sets local_port
     *
     * @param string $local_port Внутренний порт или диапазон
     *
     * @return self
     */
    public function setLocalPort($local_port)
    {
        if (is_null($local_port)) {
            array_push($this->openAPINullablesSetToNull, 'local_port');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('local_port', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets public_port
     *
     * @param string $public_port Внешний порт или диапазон
     *
     * @return self
     */
