...
/**
 * NetworkDrivePresetWrite Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkDrivePresetWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_drive_preset_write';
    ...
    */
     ...
     * Sets min
     *
     * @param float|null $min Запись IOPS
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float|null $max Запись IOPS
     *
     * @return self
     */
