 ...
 */
class NodeOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeOut';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Уникальный идентификатор ноды
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Дата и время создания ноды в формате ISO8601
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param int $ram Количество памяти
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param int $disk Количество пространства
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param int $network Пропускная способность сети
     *
     * @return self
     */
