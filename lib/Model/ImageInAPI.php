 ...
 */
class ImageInAPI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageInAPI';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['upload_url']) && (mb_strlen($this->container['upload_url']) > 65536)) {
            $invalidProperties[] = "invalid value for 'upload_url', the character length must be smaller than or equal to 65536.";
        }

        if (!is_null($this->container['upload_url']) && (mb_strlen($this->container['upload_url']) < 1)) {
    ...
    public function setUploadUrl($upload_url)
    {
        ...
        if ((mb_strlen($upload_url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $upload_url when calling ImageInAPI., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($upload_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $upload_url when calling ImageInAPI., must be bigger than or equal to 1.');
        }
