 ...
 */
class AppConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'app_configuration';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('network_bandwidth', $data ?? [], null);
    ...
    */
     ...
     * Sets cpu
     *
     * @param float|null $cpu Количество ядер процессора.
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param float|null $ram Объем оперативной памяти (в МБ).
     *
     * @return self
     */
     ...
     *
     * @param float|null $network_bandwidth Скорость сетевого канала (в Мбит/с).
     *
     * @return self
     */
    public function setNetworkBandwidth($network_bandwidth)
    {
        if (is_null($network_bandwidth)) {
            throw new \InvalidArgumentException('non-nullable network_bandwidth cannot be null');
        }
     ...
     * Sets disk_type
     *
     * @param string|null $disk_type Тип диска.
     *
     * @return self
     */
