 ...
 */
class Free implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'free';
    ...
    public const MONEY_SOURCE_FREE = 'free';
