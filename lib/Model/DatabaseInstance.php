...
/**
 * DatabaseInstance Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabaseInstance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database-instance';
    ...
    */
     ...
     * Sets description
     *
     * @param string $description Описание базы данных
     *
     * @return self
     */
