...
/**
 * ServersSoftwareRequirements Class Doc Comment
 *
 * @category Class
 ...
 */
class ServersSoftwareRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'servers_software_requirements';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bandwidth_min', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets cpu_min
     *
     * @param float|null $cpu_min Минимальной значение процессора.
     *
     * @return self
     */
     ...
     * Sets disk_min
     *
     * @param float|null $disk_min Минимальное значение диска.
     *
     * @return self
     */
     ...
     * Sets ram_min
     *
     * @param float|null $ram_min Минимальное значение оперативной памяти.
     *
     * @return self
     */
     ...
     * Sets bandwidth_min
     *
     * @param float|null $bandwidth_min Минимальное значение пропускной способности.
     *
     * @return self
     */
    public function setBandwidthMin($bandwidth_min)
    {
        if (is_null($bandwidth_min)) {
            throw new \InvalidArgumentException('non-nullable bandwidth_min cannot be null');
        }
