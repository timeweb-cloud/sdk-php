...
/**
 * GetStorageTransferStatus200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetStorageTransferStatus200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getStorageTransferStatus_200_response';
    ...
    protected static $openAPITypes = [
        'transfer_status' => '\OpenAPI\Client\Model\TransferStatus',
        'response_id' => 'string'
    ];
    ...
    {
        $this->setIfExists('transfer_status', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\TransferStatus $transfer_status transfer_status
     *
     * @return self
     */
    public function setTransferStatus($transfer_status)
    {
        if (is_null($transfer_status)) {
            throw new \InvalidArgumentException('non-nullable transfer_status cannot be null');
        }
