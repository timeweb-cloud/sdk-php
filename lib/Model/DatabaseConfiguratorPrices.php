...
/**
 * DatabaseConfiguratorPrices Class Doc Comment
 *
 * @category Class
 * @description Стоимость единицы каждого ресурса. Объект возвращается только для конфигураторов с поресурсной тарификацией.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DatabaseConfiguratorPrices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database_configurator_prices';
    ...
    */
     ...
     * Sets cpu
     *
     * @param float $cpu Стоимость одного ядра процессора.
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param float $ram Стоимость одной единицы оперативной памяти.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param float $disk Стоимость одной единицы дискового пространства.
     *
     * @return self
     */
     ...
     * Sets bandwidth
     *
     * @param float $bandwidth Стоимость одной единицы пропускной способности интернет-канала.
     *
     * @return self
     */
