 ...
 */
class RegistryOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegistryOut';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'disk_stats' => '\OpenAPI\Client\Model\RegistryOutDiskStats'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Название реестра
     *
     * @return self
     */
     ...
     *
     * @param int $configurator_id ID конфигуратора
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Дата и время создания реестра в формате ISO8601
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Дата и время обновления реестра в формате ISO8601
     *
     * @return self
     */
     ...
     * Gets disk_stats
     *
     * @return \OpenAPI\Client\Model\RegistryOutDiskStats
     */
     ...
     * Sets disk_stats
     *
     * @param \OpenAPI\Client\Model\RegistryOutDiskStats $disk_stats disk_stats
     *
     * @return self
     */
