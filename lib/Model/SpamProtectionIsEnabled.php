...
/**
 * SpamProtectionIsEnabled Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpamProtectionIsEnabled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'spam-protection-is-enabled';
    ...
    */
     ...
     * Sets filter_action
     *
     * @param string|null $filter_action Что делать с письмами, которые попадают в спам. \\  Параметры: \\  `directory` - переместить в папку спам; \\  `label` - пометить письмо; \\  Если передан параметр `is_enabled`: `false`, то значение передавать нельзя
     *
     * @return self
     */
