...
/**
 * AddCertificate Class Doc Comment
 *
 * @category Class
 * @description Параметры загрузки собственного сертификата
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AddCertificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'add-certificate';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('comment', $data ?? [], 'SSL Certificate');
    }
    ...
    */
     ...
     * Sets private_key
     *
     * @param string $private_key Приватный ключ сертификата в формате PEM.
     *
     * @return self
     */
     ...
     * Sets certificate
     *
     * @param string $certificate Сертификат вместе с цепочкой в формате PEM.
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Комментарий к сертификату.
     *
     * @return self
     */
