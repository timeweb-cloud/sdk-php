...
/**
 * GetServerStatistics200ResponseAllOfDiskInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetServerStatistics200ResponseAllOfDiskInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getServerStatistics_200_response_allOf_disk_inner';
    ...
    */
     ...
     * Sets write
     *
     * @param float $write Нагрузка на запись диска в Мб/с
     *
     * @return self
     */
     ...
     * Sets read
     *
     * @param float $read Нагрузка на чтение диска в Мб/с
     *
     * @return self
     */
