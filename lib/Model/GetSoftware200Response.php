...
/**
 * GetSoftware200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSoftware200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSoftware_200_response';
    ...
    */
    ...
    /**
     * Gets servers_software
     *
     * @return \OpenAPI\Client\Model\ServersSoftware[]
     */
    public function getServersSoftware()
    {
        return $this->container['servers_software'];
    }

    /**
     * Sets servers_software
     *
     * @param \OpenAPI\Client\Model\ServersSoftware[] $servers_software servers_software
     *
     * @return self
     */
    public function setServersSoftware($servers_software)
    {
        if (is_null($servers_software)) {
