...
/**
 * GetK8SVersions200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetK8SVersions200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getK8SVersions_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('k8s_versions', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['k8s_versions'] === null) {
            $invalidProperties[] = "'k8s_versions' can't be null";
        }
     ...
     * @return string[]
     */
    public function getK8sVersions()
    {
        return $this->container['k8s_versions'];
    }

    /**
     * Sets k8s_versions
     *
     * @param string[] $k8s_versions Массив версий k8s
     *
     * @return self
     */
    public function setK8sVersions($k8s_versions)
    {
        if (is_null($k8s_versions)) {
            throw new \InvalidArgumentException('non-nullable k8s_versions cannot be null');
        }
        $this->container['k8s_versions'] = $k8s_versions;
