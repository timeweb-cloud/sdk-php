...
/**
 * RouterNetworkMetaDhcp Class Doc Comment
 *
 * @category Class
 * @description DHCP
 * @package  OpenAPI\Client
 ...
 */
class RouterNetworkMetaDhcp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RouterNetworkMeta_dhcp';
    ...
    */
     ...
     * Sets is_enabled
     *
     * @param bool $is_enabled Включен ли DHCP
     *
     * @return self
     */
     ...
     * Sets is_available
     *
     * @param bool $is_available Доступен ли DHCP
     *
     * @return self
     */
