...
class ProjectResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'project-resource';
    ...
    public const TYPE_BALANCER = 'balancer';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор для каждого ресурса проекта. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string $created_at Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан ресурс.
     *
     * @return self
     */
     ...
     * Sets project
     *
     * @param \OpenAPI\Client\Model\Project $project project
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Тип ресурса проекта
     *
     * @return self
     */
