...
/**
 * GetBalancersPresets200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetBalancersPresets200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBalancersPresets_200_response';
    ...
    */
    ...
    /**
     * Gets balancers_presets
     *
     * @return \OpenAPI\Client\Model\PresetsBalancer[]
     */
    public function getBalancersPresets()
    {
        return $this->container['balancers_presets'];
    }

    /**
     * Sets balancers_presets
     *
     * @param \OpenAPI\Client\Model\PresetsBalancer[] $balancers_presets balancers_presets
     *
     * @return self
     */
    public function setBalancersPresets($balancers_presets)
    {
        if (is_null($balancers_presets)) {
