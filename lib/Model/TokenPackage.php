...
/**
 * TokenPackage Class Doc Comment
 *
 * @category Class
 ...
 */
class TokenPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'token-package';
    ...
    public const PACKAGE_TYPE_ADDITIONAL = 'additional';
    public const PACKAGE_TYPE_PROMO = 'promo';
    ...
    public function getPackageTypeAllowableValues()
    {
        return [
            ...
            self::PACKAGE_TYPE_ADDITIONAL,
            self::PACKAGE_TYPE_PROMO,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('token_amount', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор пакета
     *
     * @return self
     */
     ...
     * Sets model_id
     *
     * @param float $model_id ID модели, к которой применяется пакет токенов
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Название пакета токенов
     *
     * @return self
     */
     ...
     * Sets package_type
     *
     * @param string $package_type Тип пакета (base - базовый, additional - дополнительный, promo - промо)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Тип сущности, к которой относится пакет (agent - агент, knowledgebase - база знаний)
     *
     * @return self
     */
     ...
     * Sets token_amount
     *
     * @param float $token_amount Количество токенов в пакете
     *
     * @return self
     */
    public function setTokenAmount($token_amount)
    {
        if (is_null($token_amount)) {
            throw new \InvalidArgumentException('non-nullable token_amount cannot be null');
        }
     ...
     * Sets price
     *
     * @param float $price Цена пакета в целых единицах
     *
     * @return self
     */
     ...
     * Sets duration_days
     *
     * @param float|null $duration_days Продолжительность пакета в днях (null для дополнительных пакетов)
     *
     * @return self
     */
    public function setDurationDays($duration_days)
    {
        if (is_null($duration_days)) {
            array_push($this->openAPINullablesSetToNull, 'duration_days');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('duration_days', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets is_available
     *
     * @param bool $is_available Флаг, указывающий доступность пакета
     *
     * @return self
     */
