...
/**
 * FirewallGroup Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FirewallGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'firewall-group';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID группы правил.
     *
     * @return self
     */
