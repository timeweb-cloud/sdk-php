...
/**
 * GetServerDiskAutoBackupSettings200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetServerDiskAutoBackupSettings200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getServerDiskAutoBackupSettings_200_response';
    ...
    */
    ...
    {
        return $this->container['auto_backups_settings'];
    }
     ...
     * @return self
     */
    public function setAutoBackupsSettings($auto_backups_settings)
    {
        if (is_null($auto_backups_settings)) {
            throw new \InvalidArgumentException('non-nullable auto_backups_settings cannot be null');
        }
        $this->container['auto_backups_settings'] = $auto_backups_settings;
