...
/**
 * ResourceTransfer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResourceTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resource-transfer';
    ...
    public const RESOURCE_TYPE_KUBERNETES = 'kubernetes';
    public const RESOURCE_TYPE_STORAGE = 'storage';
    public const RESOURCE_TYPE_DEDICATED = 'dedicated';
    ...
    public function getResourceTypeAllowableValues()
    {
        return [
            ...
            self::RESOURCE_TYPE_KUBERNETES,
            self::RESOURCE_TYPE_STORAGE,
            self::RESOURCE_TYPE_DEDICATED,
        ];
    }
    ...
    {
        $this->setIfExists('to_project', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['to_project'] === null) {
            $invalidProperties[] = "'to_project' can't be null";
        }
    ...
    {
        return $this->container['to_project'];
    }
     ...
     * @return self
     */
    public function setToProject($to_project)
    {
        if (is_null($to_project)) {
            throw new \InvalidArgumentException('non-nullable to_project cannot be null');
        }
        $this->container['to_project'] = $to_project;
     ...
     * Sets resource_type
     *
     * @param string $resource_type Тип перемещаемого ресурса.
     *
     * @return self
     */
