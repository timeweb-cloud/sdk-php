...
/**
 * DatabaseAdmin Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabaseAdmin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database-admin';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор для каждого экземпляра пользователя базы данных. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets host
     *
     * @param string $host Хост пользователя
     *
     * @return self
     */
     ...
     * Gets instances
     *
     * @return \OpenAPI\Client\Model\DatabaseAdminInstancesInner[]
     */
     ...
     * Sets instances
     *
     * @param \OpenAPI\Client\Model\DatabaseAdminInstancesInner[] $instances instances
     *
     * @return self
     */
