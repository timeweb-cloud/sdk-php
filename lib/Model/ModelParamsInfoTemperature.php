...
/**
 * ModelParamsInfoTemperature Class Doc Comment
 *
 * @category Class
 * @description Параметр температуры
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelParamsInfoTemperature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_params_info_temperature';
