...
/**
 * ContainerRegistryPresetsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContainerRegistryPresetsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Container_Registry_presets_inner';
    ...
    */
     ...
     * Sets disk
     *
     * @param int $disk Количество пространства в ГБ
     *
     * @return self
     */
