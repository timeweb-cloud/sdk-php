...
/**
 * GetFinances200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetFinances200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getFinances_200_response';
    ...
    protected static $openAPITypes = [
        'finances' => '\OpenAPI\Client\Model\Finances',
        'response_id' => 'string'
    ];
    ...
    {
        $this->setIfExists('finances', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['finances'] === null) {
            $invalidProperties[] = "'finances' can't be null";
        }
     ...
     * Gets finances
     *
     * @return \OpenAPI\Client\Model\Finances
     */
     ...
     * Sets finances
     *
     * @param \OpenAPI\Client\Model\Finances $finances finances
     *
     * @return self
     */
    ...
    {
        if (is_null($finances)) {
            throw new \InvalidArgumentException('non-nullable finances cannot be null');
        }
