...
/**
 * StaticRouteIn Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StaticRouteIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StaticRouteIn';
    ...
    */
     ...
     * Sets nexthop
     *
     * @param string $nexthop IP-адрес следующего узла (IPv4)
     *
     * @return self
     */
