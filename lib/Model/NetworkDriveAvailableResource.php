...
/**
 * NetworkDriveAvailableResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NetworkDriveAvailableResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network-drive-available-resource';
    ...
    */
     ...
     * Sets resource_id
     *
     * @param float $resource_id Уникальный идентификатор сервиса.
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string|null $ip IP-адрес сервиса.
     *
     * @return self
     */
