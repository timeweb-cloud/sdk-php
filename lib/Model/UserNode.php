...
/**
 * UserNode Class Doc Comment
 *
 * @category Class
 * @description Узел CDN, который раздает контент ресурса пользователям
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UserNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user-node';
    ...
    */
     ...
     * Sets ipv4_address
     *
     * @param string $ipv4_address IPv4-адрес раздающего узла.
     *
     * @return self
     */
