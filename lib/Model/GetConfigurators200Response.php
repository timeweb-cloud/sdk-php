...
/**
 * GetConfigurators200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetConfigurators200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getConfigurators_200_response';
    ...
    */
    ...
    /**
     * Gets server_configurators
     *
     * @return \OpenAPI\Client\Model\ServersConfigurator[]
     */
    public function getServerConfigurators()
    {
        return $this->container['server_configurators'];
    }

    /**
     * Sets server_configurators
     *
     * @param \OpenAPI\Client\Model\ServersConfigurator[] $server_configurators server_configurators
     *
     * @return self
     */
    public function setServerConfigurators($server_configurators)
    {
        if (is_null($server_configurators)) {
