...
/**
 * AddedSubdomain Class Doc Comment
 *
 * @category Class
 ...
 */
class AddedSubdomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'added-subdomain';
    ...
    public const STATUS_EMPTY_CNAME = 'empty_cname';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Результат добавления поддомена.
     *
     * @return self
     */
