 ...
 */
class AutoBackup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auto-backup';
    ...
    */
     ...
     * Sets copy_count
     *
     * @param float|null $copy_count Количество копий для хранения. Минимальное количество `1`, максимальное `99`
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $creation_start_at Дата начала создания первого автобэкапа. Значение в формате `ISO8601`. Время не учитывается.
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval Периодичность создания автобэкапов
     *
     * @return self
     */
     ...
     * Sets day_of_week
     *
     * @param float|null $day_of_week День недели, в который будут создаваться автобэкапы. Работает только со значением `interval`: `week`. Доступные значение от `1 `до `7`.
     *
     * @return self
     */
