...
/**
 * AddServerIPRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddServerIPRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addServerIP_request';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Тип IP-адреса
     *
     * @return self
     */
     ...
     * Sets ptr
     *
     * @param string|null $ptr PTR-запись IP-адреса
     *
     * @return self
     */
