...
/**
 * GetDatabasesPresets200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDatabasesPresets200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDatabasesPresets_200_response';
    ...
    */
    ...
    /**
     * Gets databases_presets
     *
     * @return \OpenAPI\Client\Model\PresetsDbs[]
     */
    public function getDatabasesPresets()
    {
        return $this->container['databases_presets'];
    }

    /**
     * Sets databases_presets
     *
     * @param \OpenAPI\Client\Model\PresetsDbs[] $databases_presets databases_presets
     *
     * @return self
     */
    public function setDatabasesPresets($databases_presets)
    {
        if (is_null($databases_presets)) {
