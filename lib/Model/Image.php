...
class Image implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param string $created_at Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан образ.
     *
     * @return self
     */
     ...
     * Sets deleted_at
     *
     * @param string $deleted_at Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был удален образ.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int $size Размер физического диска в мегабайтах.
     *
     * @return self
     */
     ...
     * Sets virtual_size
     *
     * @param int $virtual_size Размер виртуального диска в мегабайтах.
     *
     * @return self
     */
     ...
     * Sets disk_id
     *
     * @param int $disk_id ID связанного с образом диска.
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string $location Локация образа.
     *
     * @return self
     */
     ...
     * Sets is_custom
     *
     * @param bool $is_custom Логическое значение, которое показывает, является ли образ кастомным.
     *
     * @return self
     */
