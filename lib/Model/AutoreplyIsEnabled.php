...
class AutoreplyIsEnabled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'autoreply-is-enabled';
    ...
    */
     ...
     *
     * @param string|null $autoreply_message Сообщение автоответчика на входящие письма. \\  Если передан параметр `is_enabled`: `false`, то значение передавать нельзя
     *
     * @return self
     */
     ...
     *
     * @param string|null $autoreply_subject Тема сообщения автоответчика на входящие письма. \\  Если передан параметр `is_enabled`: `false`, то значение передавать нельзя
     *
     * @return self
     */
