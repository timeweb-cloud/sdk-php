...
/**
 * DatabaseClusterReplicaListInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatabaseClusterReplicaListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'database_cluster_replica_list_inner';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'local_ip' => 'string',
        'disk' => '\OpenAPI\Client\Model\DatabaseClusterReplicaListInnerDisk'
    ];
    ...
    */
     ...
     * Sets db_id
     *
     * @param int $db_id ID кластера базы данных, которому принадлежит реплика.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Текущий статус реплики.
     *
     * @return self
     */
     ...
     * Sets local_ip
     *
     * @param string $local_ip Адрес реплики в локальной сети.
     *
     * @return self
     */
     ...
     * Gets disk
     *
     * @return \OpenAPI\Client\Model\DatabaseClusterReplicaListInnerDisk|null
     */
     ...
     * Sets disk
     *
     * @param \OpenAPI\Client\Model\DatabaseClusterReplicaListInnerDisk|null $disk disk
     *
     * @return self
     */
