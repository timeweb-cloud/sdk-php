...
/**
 * AddBitbucket Class Doc Comment
 *
 * @category Class
 * @description Добавление аккаунта Bitbucket
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AddBitbucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'add-bitbucket';
    ...
    public const PROVIDER_TYPE_BITBUCKET = 'bitbucket';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('provider_token', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['provider_token'] === null) {
            $invalidProperties[] = "'provider_token' can't be null";
        }
    ...
    {
        if (is_null($provider_token)) {
            throw new \InvalidArgumentException('non-nullable provider_token cannot be null');
        }
