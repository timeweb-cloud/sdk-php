 ...
 */
class Clusterk8s implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'clusterk8s';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор для каждого экземпляра крастера. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Удобочитаемое имя, установленное для кластера.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан кластер.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус кластера.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Описание кластера.
     *
     * @return self
     */
     ...
     * Sets ha
     *
     * @param bool $ha Описание появится позднее.
     *
     * @return self
     */
     ...
     * Sets k8s_version
     *
     * @param string $k8s_version Версия k8s.
     *
     * @return self
     */
     ...
     * Sets network_driver
     *
     * @param string $network_driver Описание появится позднее.
     *
     * @return self
     */
     ...
     * Sets ingress
     *
     * @param bool $ingress Описание появится позднее.
     *
     * @return self
     */
     ...
     * Sets cpu
     *
     * @param float $cpu Количество ядер процессора кластера.
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param float $ram Количество (в Мб) оперативной памяти кластера.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param float $disk Размер (в Гб) диска кластера.
     *
     * @return self
     */
     ...
     * Sets preset_id
     *
     * @param float $preset_id Тип сервиса кластера.
     *
     * @return self
     */
