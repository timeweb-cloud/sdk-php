...
/**
 * DedicatedServerPreset Class Doc Comment
 *
 * @category Class
 ...
 */
class DedicatedServerPreset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dedicated-server-preset';
    ...
    protected static $openAPITypes = [
        ...
        'price' => 'float',
        'memory' => '\OpenAPI\Client\Model\DedicatedServerPresetMemory',
        'location' => 'string'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор тарифа выделенного сервера.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Описание характеристик тарифа выделенного сервера.
     *
     * @return self
     */
    ...
    /**
     * Gets is_ipmi_enabled
     *
     * @return bool
     */
    public function getIsIpmiEnabled()
    {
        return $this->container['is_ipmi_enabled'];
    }

    /**
     * Sets is_ipmi_enabled
     *
     * @param bool $is_ipmi_enabled Это логическое значение, которое показывает, доступен ли IPMI у данного тарифа.
     *
     * @return self
     */
    public function setIsIpmiEnabled($is_ipmi_enabled)
    {
        if (is_null($is_ipmi_enabled)) {
     ...
     * Gets cpu
     *
     * @return \OpenAPI\Client\Model\DedicatedServerPresetCpu
     */
     ...
     * Sets cpu
     *
     * @param \OpenAPI\Client\Model\DedicatedServerPresetCpu $cpu cpu
     *
     * @return self
     */
     ...
     * Gets disk
     *
     * @return \OpenAPI\Client\Model\DedicatedServerPresetDisk
     */
     ...
     * Sets disk
     *
     * @param \OpenAPI\Client\Model\DedicatedServerPresetDisk $disk disk
     *
     * @return self
     */
     ...
     * Gets memory
     *
     * @return \OpenAPI\Client\Model\DedicatedServerPresetMemory
     */
     ...
     * Sets memory
     *
     * @param \OpenAPI\Client\Model\DedicatedServerPresetMemory $memory memory
     *
     * @return self
     */
