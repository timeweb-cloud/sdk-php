...
/**
 * CreateMultipleDomainMailboxesV2RequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateMultipleDomainMailboxesV2RequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createMultipleDomainMailboxesV2_request_inner';
    ...
    */
     ...
     * Sets login
     *
     * @param string $login Название почтового ящика
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Комментарий почтового ящика
     *
     * @return self
     */
     ...
     * Sets filter_status
     *
     * @param bool|null $filter_status Статус фильтрации почты
     *
     * @return self
     */
     ...
     * Sets filter_action
     *
     * @param string|null $filter_action Что делать с письмами, которые попадают в спам. \\  Параметры: \\  `directory` - переместить в папку спам; \\  `label` - пометить письмо; \\  Если передан параметр `filter_status`: `false`, то значение передавать нельзя
     *
     * @return self
     */
