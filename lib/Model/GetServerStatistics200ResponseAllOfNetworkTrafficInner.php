...
/**
 * GetServerStatistics200ResponseAllOfNetworkTrafficInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetServerStatistics200ResponseAllOfNetworkTrafficInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getServerStatistics_200_response_allOf_network_traffic_inner';
    ...
    */
     ...
     * Sets incoming
     *
     * @param float $incoming Входящий трафик сети в Мб/с
     *
     * @return self
     */
     ...
     * Sets outgoing
     *
     * @param float $outgoing Исходящий трафик сети в Мб/с
     *
     * @return self
     */
