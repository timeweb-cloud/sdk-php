...
/**
 * ForwardIsEnabled Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ForwardIsEnabled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'forward-is-enabled';
    ...
    protected static $attributeMap = [
        ...
        'is_leave_messages' => 'is_leave_messages'
    ];
    ...
    protected static $setters = [
        ...
        'is_leave_messages' => 'setIsLeaveMessages'
    ];
    ...
    protected static $getters = [
        ...
        'is_leave_messages' => 'getIsLeaveMessages'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_leave_messages', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets is_enabled
     *
     * @param bool $is_enabled Включена ли пересылка входящих писем
     *
     * @return self
     */
     ...
     * Sets forward_list
     *
     * @param string[] $forward_list Список адресов для пересылки. \\  Если передан параметр `is_enabled`: `false`, то значение передавать нельзя
     *
     * @return self
     */
    ...
    /**
     * Gets is_leave_messages
     *
     * @return bool|null
     */
    public function getIsLeaveMessages()
    {
        return $this->container['is_leave_messages'];
    }
     ...
     * @return self
     */
    public function setIsLeaveMessages($is_leave_messages)
    {
        if (is_null($is_leave_messages)) {
            throw new \InvalidArgumentException('non-nullable is_leave_messages cannot be null');
        }
        $this->container['is_leave_messages'] = $is_leave_messages;
