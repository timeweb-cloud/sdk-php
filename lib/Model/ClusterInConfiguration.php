...
/**
 * ClusterInConfiguration Class Doc Comment
 *
 * @category Class
 * @description Параметры конфигурации мастер-ноды. Нельзя передавать вместе с &#x60;preset_id&#x60;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ClusterInConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClusterIn_configuration';
    ...
    */
     ...
     *
     * @param int $configurator_id ID конфигуратора мастер-ноды
     *
     * @return self
     */
