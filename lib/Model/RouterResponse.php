...
/**
 * RouterResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RouterResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RouterResponse';
    ...
    protected static $openAPITypes = [
        'response_id' => 'string',
        'router' => '\OpenAPI\Client\Model\RouterOut'
    ];
    ...
    */
     ...
     * Sets router
     *
     * @param \OpenAPI\Client\Model\RouterOut $router router
     *
     * @return self
     */
