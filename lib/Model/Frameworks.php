...
class Frameworks
{
    ...
    public const BEEGO = 'beego';

    public const FASTAPI = 'fastapi';

    public const ASP_NET_CORE = 'ASP.NET Core';

    public const HAPI = 'hapi';
