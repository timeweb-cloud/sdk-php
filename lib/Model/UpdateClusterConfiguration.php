...
/**
 * UpdateClusterConfiguration Class Doc Comment
 *
 * @category Class
 * @description Конфигуратор кластера базы данных. Нельзя передавать вместе с &#x60;preset_id&#x60;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateClusterConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_cluster_configuration';
    ...
    */
     ...
     * Sets disk
     *
     * @param int $disk Размер диска (в Мб). Значение должно быть кратно 1024
     *
     * @return self
     */
     ...
     * Sets ram
     *
     * @param int $ram Объем оперативной памяти (в Мб). Значение должно быть кратно 1024
     *
     * @return self
     */
