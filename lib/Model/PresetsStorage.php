...
/**
 * PresetsStorage Class Doc Comment
 *
 * @category Class
 * @description Тариф
 * @package  OpenAPI\Client
 ...
 */
class PresetsStorage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'presets-storage';
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор для каждого экземпляра тарифа хранилища.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param float $disk Описание диска хранилища.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float $price Стоимость тарифа хранилища.
     *
     * @return self
     */
