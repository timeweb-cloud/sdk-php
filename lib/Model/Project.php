...
class Project implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param float $id ID для каждого проекта. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets avatar_id
     *
     * @param string $avatar_id ID аватара пользователя. Описание методов работы с аватарами появится позднее.
     *
     * @return self
     */
