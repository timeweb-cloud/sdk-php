...
class Project implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param float $id Уникальный идентификатор для каждого проекта. Автоматически генерируется при создании.
     *
     * @return self
     */
     ...
     * Sets avatar_id
     *
     * @param string $avatar_id Идентификатор аватара пользователя. Описание методов работы с аватарами появится позднее.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Удобочитаемое имя проекта.
     *
     * @return self
     */
     ...
     * Sets is_default
     *
     * @param bool $is_default Это логическое значение, которое показывает, выбран ли проект по умолчанию для создания новых сущностей.
     *
     * @return self
     */
