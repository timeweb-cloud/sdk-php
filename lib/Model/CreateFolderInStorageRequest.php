...
/**
 * CreateFolderInStorageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateFolderInStorageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createFolderInStorage_request';
    ...
    */
     ...
     * Sets dir_name
     *
     * @param string $dir_name Название директории.
     *
     * @return self
     */
