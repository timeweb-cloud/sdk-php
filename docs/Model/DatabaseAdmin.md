...
**created_at** | **string** | Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан пользователь базы данных. |
...
**for_all** | **bool** | Флаг, выданы ли пользователю привилегии на все инстансы базы данных |
**is_reset_password** | **bool** | Флаг, был ли сброшен пароль пользователя |
