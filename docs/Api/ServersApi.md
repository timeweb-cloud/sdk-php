...
try {
    ...
    echo 'Exception when calling ServersApi->commitRestorePoint: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ServersApi->createRestorePoint: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ServersApi->getRestorePoint: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ServersApi->getRestorePoints: ', $e->getMessage(), PHP_EOL;
}
```
...
$server_id = 1051; // int | ID облачного сервера.
$date_from = 'date_from_example'; // string | Дата начала сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-25T14%3A35%3A38`
$date_to = 'date_to_example'; // string | Дата окончания сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-26T14%3A35%3A38`
...
| ------------- | ------------- | ------------- | ------------- |
| **server_id** | **int**| ID облачного сервера. | |
| **date_from** | **string**| Дата начала сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: &#x60;2023-05-25T14%3A35%3A38&#x60; | |
| **date_to** | **string**| Дата окончания сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: &#x60;2023-05-26T14%3A35%3A38&#x60; | |
...
try {
    $apiInstance->rebootServerHard($server_id);
} catch (Exception $e) {
    echo 'Exception when calling ServersApi->rebootServerHard: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ServersApi->rollbackRestorePoint: ', $e->getMessage(), PHP_EOL;
}
```
